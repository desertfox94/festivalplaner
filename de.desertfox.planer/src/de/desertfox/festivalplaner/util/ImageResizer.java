...
public class ImageResizer {
    ...
    public static org.eclipse.swt.graphics.Image resize (org.eclipse.swt.graphics.Image image, float scale) {
        ...
        return resize(image, newWidth, newHeight, mode);
    }
    /**
     * 
     * @param image
     * @param newWidth
     * @param newHeight
     * @param mode scale < 1 ? BufferedImage.SCALE_AREA_AVERAGING : BufferedImage.SCALE_SMOOTH
     * @return
     */
    public static org.eclipse.swt.graphics.Image resize (org.eclipse.swt.graphics.Image image, int newWidth, int newHeight, int mode) {
